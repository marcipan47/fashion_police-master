...
public class ColorService {
    ...
    public static void colorGames() {
        ...
        colorstab.put("aqua", new ArrayList<>(Arrays.asList("aqua", "blue", "red", MARRON, BEIGE, "pink", "navy", ORANGE, PURPLE, WHITE, SILVER, BLACK, GREY)));
        ...
        colorstab.put("blue", new ArrayList<>(Arrays.asList("blue", "aqua", "red", MARRON, BEIGE, "navy", ORANGE, "pink", PURPLE, WHITE, SILVER, BLACK, GREY)));
        colorstab.put(FUCHSIA, new ArrayList<>(Arrays.asList(FUCHSIA, "lime", GREEN, "pink", PURPLE, "aqua", "blue", YELLOW, ORANGE, "navy", SILVER, WHITE, BLACK, GREY)));
        colorstab.put(GREEN, new ArrayList<>(Arrays.asList(GREEN, YELLOW, "lime", FUCHSIA, "pink", PURPLE, "navy", "red", ORANGE, MARRON, BEIGE, WHITE, BLACK, GREY)));
        ...
        colorstab.put(OLIVE, new ArrayList<>(Arrays.asList(OLIVE, FUCHSIA , PURPLE, ORANGE, BEIGE, YELLOW, "lime", "teal", MARRON, WHITE, BLACK, GREY)));
        colorstab.put(PURPLE, new ArrayList<>(Arrays.asList(PURPLE, OLIVE, YELLOW, ORANGE, GREEN, "pink", "teal", SILVER, WHITE, BLACK, GREY)));
        ...
        colorstab.put("teal", new ArrayList<>(Arrays.asList("teal", "pink", FUCHSIA, BEIGE, PURPLE, "red", ORANGE, MARRON, WHITE, BLACK, GREY)));
        ...
        colorstab.put(YELLOW, new ArrayList<>(Arrays.asList(YELLOW, GREEN, MARRON, PURPLE, FUCHSIA, "navy", ORANGE, WHITE, BLACK, GREY)));
        colorstab.put(ORANGE, new ArrayList<>(Arrays.asList(ORANGE, "blue", GREEN, PURPLE, MARRON, WHITE, "navy", "red", "teal", BLACK, GREY)));
        colorstab.put(BEIGE, new ArrayList<>(Arrays.asList(BEIGE, "teal", "blue", WHITE, BROWN, "navy", "pink", YELLOW, "aqua", ORANGE, BLACK, GREY)));
        colorstab.put("pink", new ArrayList<>(Arrays.asList("pink", "teal", "lime", "aqua", PURPLE, "blue", GREEN, WHITE, BLACK, GREY)));
        colorstab.put(BROWN, new ArrayList<>(Arrays.asList(BROWN, "teal", "blue", WHITE, BEIGE, "navy", "pink", YELLOW, "aqua", ORANGE, BLACK, GREY)));
    }
}
